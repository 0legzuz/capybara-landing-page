    ...
    <S.Container>
      ...
      <S.SectionQuestionBox>
        <S.SectionQuestion>
          ...
          <S.HeaderImg src="/1.png" alt="Capybara" />
        </S.SectionQuestion>
      </S.SectionQuestionBox>
      <S.SectionInfoBox>
        <S.SectionInfo id="section1">
          ...
          <S.InfoImg src="/2.jpg" alt="Capybara in the pool" />
        </S.SectionInfo>
      </S.SectionInfoBox>
      <S.SectionSizeBox>
        <S.SectionSize id="section2">
          ...
          <S.SizeLinesBox>
            <S.SizeImg src="/3.png" alt="Capybara" />
            <S.SizeLinesHeight>
      ...
      <S.SectionWhereBox>
        <S.SectionWhere id="section3">
          ...
          <S.WhereBox>
            <S.WhereImg src="/4.png" alt="America" />
            <S.WhereText>
      ...
      <S.SectionSocialBox>
        <S.SectionSocial id="section4">
          ...
          <S.SocialBox>
            ...
            <S.SocialImg src="/5.jpg" alt="Capybara Family" />
          </S.SocialBox>
        </S.SectionSocial>
      </S.SectionSocialBox>
      ...
      <S.Footer>
        <S.NavigationLinks>
          <S.Link href="/terms-of-service">Условия использования</S.Link>
          <S.Link href="/privacy-policy">Политика конфиденциальности</S.Link>
          <S.Link href="/contact-us">Связаться с нами</S.Link>
        </S.NavigationLinks>
        <S.SvgBox>
          <S.LinkSvg
            alt="Telegram"
